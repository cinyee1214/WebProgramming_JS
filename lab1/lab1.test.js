...
console.log("Test of questionOne: ");

console.log(lab1.questionOne([1, 2, 3])); 
// should output 14

console.log(lab1.questionOne([3, 5, 10])); 
// should output 134

console.log(lab1.questionOne([-1, -2, -3])); 
// should output 14

console.log(lab1.questionOne([7, -8, 0])); 
// should output 113

console.log(lab1.questionOne([2, 4, 13])); 
// should output 189

console.log("Test of questionTwo: ");
...
console.log("Test of questionThree: ");
...
console.log(lab1.questionThree("ABCDEFG HIJKLMN opqrst uvwxyz."));
// should output 5

console.log("Test of questionFour: ");
